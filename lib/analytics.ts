export type AnalyticsEvent = "primary_cta" | "form_open" | "form_submit" | "form_success" | "form_error" | "language_change" | "commercial_view" | "guide_view" | "commercial_internal_click";
